...
- (UIPickerView *)pickerView
{
    if (!_pickerView) {
        ...
        CGFloat pickerX = 0;
        CGFloat pickerY = [UIScreen mainScreen].bounds.size.height + 44 - KBottomHeight;
...
{
    if (!_toolBar) {
        _toolBar = [[YJToolBar alloc]initWithTitle:@"选择城市"
        ...
        _toolBar.x = 0;
        _toolBar.y = [UIScreen mainScreen].bounds.size.height-KBottomHeight;
    }
    return _toolBar;
}
