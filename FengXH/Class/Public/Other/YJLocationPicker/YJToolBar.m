...
//横向
#define scaleHorizontal  KMAINSIZE.width/750.0f
//竖直
#define scaleVertical  KMAINSIZE.height/1333.0f
...
//
//    }];
    self.cancleButton.frame = CGRectMake(20*scaleHorizontal, 20*scaleVertical, 70*scaleHorizontal, 50*scaleVertical);
    self.confirmButton.frame = CGRectMake(660*scaleHorizontal, 20*scaleVertical, 70*scaleHorizontal, 50*scaleVertical);
    self.titleLabel.frame = CGRectMake(250*scaleHorizontal, 20*scaleVertical, 250*scaleHorizontal, 50*scaleVertical);
