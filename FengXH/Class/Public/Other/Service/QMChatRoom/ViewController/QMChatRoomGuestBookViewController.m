...
- (void)createUI {
    self.messageTextView = [[UITextView alloc] initWithFrame:CGRectMake(5, CGRectGetMaxY(self.messageLabel.frame)+10, KMAINSIZE.width-40, 120)];
    ...
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, KMAINSIZE.width, 100)];
    ...
    self.submitBtn.frame = CGRectMake(20, 30, KMAINSIZE.width-40, 44);
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, KMAINSIZE.width, KMAINSIZE.height-KBottomHeight-64) style:UITableViewStyleGrouped];
...
- (void)keyboardFrameChange: (NSNotification *)notification {
    ...
    if (newFrame.origin.y == [UIScreen mainScreen].bounds.size.height) {
        [UIView animateWithDuration:0.3 animations:^{
            _tableView.frame = CGRectMake(0, 0, KMAINSIZE.width, KMAINSIZE.height-KBottomHeight-64);
        }];
    }else {
        [UIView animateWithDuration:0.3 animations:^{
            _tableView.frame = CGRectMake(0, 0, KMAINSIZE.width, [UIScreen mainScreen].bounds.size.height-64-newFrame.size.height);
        }];
    }
}
