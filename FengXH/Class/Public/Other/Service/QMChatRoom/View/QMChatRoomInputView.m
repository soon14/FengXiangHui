...
- (void)createView {
    ...
    //输入框
    self.inputView = [[UITextView alloc] initWithFrame:CGRectMake(50, 8, KMAINSIZE.width-140, 34)];
    ...
    self.RecordBtn.frame = CGRectMake(50, 8, KMAINSIZE.width-140, 34);
    ...
    self.faceButton.frame = CGRectMake(KMAINSIZE.width-kInputViewHeight*2+20, 0, kInputViewHeight-10, kInputViewHeight);
    ...
    self.addButton.frame = CGRectMake(KMAINSIZE.width-kInputViewHeight+10, 0, kInputViewHeight-10, kInputViewHeight);
