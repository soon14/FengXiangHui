...
- (void)createUI {
    ...
    _fileName.frame = CGRectMake(90, 10, KMAINSIZE.width -150, 20);
    ...
    _fileSize.frame = CGRectMake(90, 30, KMAINSIZE.width-150, 20);
    ...
    _fileDate.frame = CGRectMake(90, 50, KMAINSIZE.width-150, 20);
