...
-(void)createUI {
    ...
    _videoName.frame = CGRectMake(90, 10, KMAINSIZE.width-150, 20);
    ...
    _videoSize.frame = CGRectMake(90, 30, KMAINSIZE.width-150, 20);
    ...
    _videoDate.frame = CGRectMake(90, 50, KMAINSIZE.width-150, 20);
    ...
    self.pickedItemImageView.frame = CGRectMake(KMAINSIZE.width-50, 25, 30, 30);
