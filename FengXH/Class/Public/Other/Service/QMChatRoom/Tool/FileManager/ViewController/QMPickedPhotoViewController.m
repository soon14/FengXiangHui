...
- (void)viewDidLoad {
    ...
    layout.itemSize = CGSizeMake((KMAINSIZE.width-6)/3, (KMAINSIZE.width-6)/3);
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, KMAINSIZE.width, KMAINSIZE.height-KBottomHeight-_navHeight-44) collectionViewLayout:layout];
    ...
    _tabbarView.frame = CGRectMake(0, KMAINSIZE.height-KBottomHeight-44-_navHeight, KMAINSIZE.width, 44);
