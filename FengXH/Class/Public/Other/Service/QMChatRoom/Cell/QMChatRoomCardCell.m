...
- (void)createUI {
    ...
    _headerLabel.frame = CGRectMake(80, 10, KMAINSIZE.width - 90, 30);
...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    _cardView.frame = CGRectMake(0, CGRectGetMaxY(self.timeLabel.frame)+10, KMAINSIZE.width, 150);
    ...
    CGFloat strHeight = [self calcLabelHeight:message.cardHeader font:[UIFont systemFontOfSize:15.0f] width:KMAINSIZE.width - 90];
    _subheadLabel.text = message.cardSubhead;
    _priceLabel.text = message.cardPrice;

    _headerLabel.frame = CGRectMake(80, 10, KMAINSIZE.width - 90, strHeight);
    _subheadLabel.frame = CGRectMake(80, CGRectGetMaxY(_headerLabel.frame)+5, KMAINSIZE.width - 90, 20);
    _priceLabel.frame = CGRectMake(80, CGRectGetMaxY(_subheadLabel.frame)+10, KMAINSIZE.width - 90, 20);
    _sendButton.frame = CGRectMake(KMAINSIZE.width/2-40, CGRectGetMaxY(_priceLabel.frame)+10, 80, 25);
}
