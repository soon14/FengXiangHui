...
@interface IntegralPayOrderInfoCell ()
...
@implementation IntegralPayOrderInfoCell
...
- (void)setResultModel:(IntegralCreatOrderResultModel *)resultModel {
    ...
    [self.orderNumberLabel setText:_resultModel.orderID];
    [self.orderPriceLabel setText:[NSString stringWithFormat:@"%@",_resultModel.price]];
}
