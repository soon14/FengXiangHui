...
#import "OrderTypeButtonView.h"

@interface MyOrderBaseViewController ()<UIScrollViewDelegate>

@property(nonatomic , strong)OrderTypeButtonView *topButtonView;
...
- (OrderTypeButtonView *)topButtonView {
    if (!_topButtonView) {
        _topButtonView = [[OrderTypeButtonView alloc]initWithFrame:CGRectMake(0, 0, KMAINSIZE.width, 42)];
        MJWeakSelf
...
- (void)AddChildViewControllers {
    MyOrderViewController *allOrderVC = [[MyOrderViewController alloc]initWithType:0];
    MyOrderViewController *waitPaidVC = [[MyOrderViewController alloc]initWithType:1];
    MyOrderViewController *waitSendVC = [[MyOrderViewController alloc]initWithType:2];
    MyOrderViewController *waitReceiveVC = [[MyOrderViewController alloc]initWithType:3];
    MyOrderViewController *waitEvaluateVC = [[MyOrderViewController alloc]initWithType:4];
